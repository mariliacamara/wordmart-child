<?php
/**
 * Conteúdo do produto na listagem (arquivo) — usando o mesmo markup do bloco related products
 * Colocar em: wp-content/themes/woodmart-child/woocommerce/content-product.php
 */
defined( 'ABSPATH' ) || exit;

global $product;

// Safety: se produto inválido, sai
...
<li <?php wc_product_class( 'product-grid-item product wd-hover-standard', $product ); ?> data-id="<?php echo esc_attr( $product->get_id() ); ?>">
  ...
  <div class="product-wrapper">
    ...
    <div class="product-element-top wd-quick-shop">
      ...
      <?php
      // mantém comportamento de hover (igual related)
    ...
    <div class="product-element-bottom">
      <div class="product-brand-title-wrap">
        ...
        <!-- Título -->
        <h3 class="wd-entities-title"><a href="<?php echo esc_url( get_permalink( $product->get_id() ) ); ?>"><?php echo wp_kses_post( $product->get_name() ); ?></a></h3>
      </div>
      ...
      <div class="product-cta-row">
        ...
        // Botão adicionar ao carrinho (mantém ajax + atributos)
